...
export const EconomyConfig = {
  ...
  shopLargeIncome: 80,
  mallIncome: 250,
  financialCenterIncome: 1000,
  factorySmallIncome: 50,
  factoryLargeIncome: 180,
  chemicalPlantIncome: 600,
  highTechFactoryIncome: 2500,
  levelIncomeMultiplier: 0.05, // +5% per level
};

export const MILESTONES: Milestone[] = [
  { level: 1, name: 'Лагерь', requiredPop: 0 },
  { level: 2, name: 'Деревня', requiredPop: 30 },
  { level: 3, name: 'Поселок', requiredPop: 100 },
  { level: 4, name: 'Городок', requiredPop: 300 },
  { level: 5, name: 'Райцентр', requiredPop: 800 },
  { level: 6, name: 'Город', requiredPop: 1800 },
  { level: 7, name: 'Мегаполис', requiredPop: 4000 },
  { level: 8, name: 'Столица', requiredPop: 7500 },
];
...
export const BUILDINGS: Record<BuildingType, BuildingConfig> = {
  ...
  [BuildingType.HouseMedium]: {
    ...
    cost: 150,
    name: 'Средний дом',
    description: '+3 Жит/день. Макс: 24',
    color: '#ef4444',
    popGen: 3,
    incomeGen: 0,
    minLevel: 2,
  ...
  [BuildingType.HouseLarge]: {
    ...
    cost: 600,
    name: 'Большой дом',
    description: '+6 Жит/день. Макс: 50',
    color: '#b91c1c',
    popGen: 6,
    incomeGen: 0,
    minLevel: 3,
