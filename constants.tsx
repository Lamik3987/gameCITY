...
export const MILESTONES: Milestone[] = [
  ...
  { level: 2, name: 'Деревня', requiredPop: 40 },
  { level: 3, name: 'Поселок', requiredPop: 120 },
  { level: 4, name: 'Городок', requiredPop: 400 },
  { level: 5, name: 'Райцентр', requiredPop: 1000 },
  { level: 6, name: 'Город', requiredPop: 2200 },
  { level: 7, name: 'Мегаполис', requiredPop: 5000 },
  { level: 8, name: 'Столица', requiredPop: 8500 },
];
...
export const BUILDINGS: Record<BuildingType, BuildingConfig> = {
  ...
  [BuildingType.HouseMedium]: {
    ...
    cost: 150,
    name: 'Средний дом',
    description: '+3 Жит/день. Макс: 18',
    color: '#ef4444',
    popGen: 3,
    incomeGen: 0,
    minLevel: 2,
  ...
  [BuildingType.HouseLarge]: {
    ...
    cost: 600,
    name: 'Большой дом',
    description: '+6 Жит/день. Макс: 35',
    color: '#b91c1c',
    popGen: 6,
    incomeGen: 0,
    minLevel: 3,
